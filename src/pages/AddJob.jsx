          ...
          <form onSubmit={addJob}>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                onChange={(e) => {
                  setJobCompanyDescription(e.target.value);
                }}
              ></textarea>
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                required
                value={jobCompanyContactEmail}
                onChange={(e) => {
                  setJobCompanyContactEmail(e.target.value);
                }}
              />
            </div>
            <div className="mb-4">
              ...
              <input
                ...
                value={jobCompanyPhone}
                onChange={(e) => {
                  setJobCompanyPhone(e.target.value);
                }}
              />
            </div>
